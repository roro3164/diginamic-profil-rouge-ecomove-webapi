...
namespace ecomove_back.Interfaces.IRepositories
{
    public interface IVehicleRepository
    {
        ...
        public Task<List<VehicleForGetDTO>> GetAllVehiclesAsync();
        ...
        public Task<Response<bool>> ChangeVehicleStatusAsync(Guid vehicleId, VehicleForChangeStatusDTO statusDto);
